      ...
      <section id="about" className="py-24 relative border-t border-white/5">
        <div className="max-w-7xl mx-auto px-6 relative grid md:grid-cols-[320px_1fr] gap-16">
          <div className="md:sticky md:top-28 self-start">
            <span className="text-purple-400 font-bold tracking-widest uppercase text-sm mb-4 block">Who are we</span>
            <h2 className="text-5xl font-black uppercase leading-tight mb-6" style={{ fontFamily: "'Barlow Condensed', sans-serif" }}>
              Our <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-violet-300">Vision</span>
            </h2>
            <p className="text-gray-400 leading-relaxed">
              We're an organization built on talent, competition, and the drive to create opportunities for the next generation of players.
            </p>
          </div>
          <div>
            <PillarCard
              ...
              description="We provide a platform for players, creators, and rising talent to grow while supporting the development of esports alongside the Algerian National Committee for Electronic Sports."
            />
            <PillarCard
              index={2}
              ...
              description="We compete across the world's biggest esports titles, representing Nebula Esports in national and international tournaments."
            />
            <PillarCard
              index={3}
              ...
              description="We discover promising players, provide the right environment to grow, and help them reach their competitive potential."
            />
          </div>
        </div>
      </section>
